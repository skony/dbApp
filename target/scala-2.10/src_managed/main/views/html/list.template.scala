            ...
            <tbody>
                ...
                """),_display_(Seq[Any](/*35.18*/for(course <- courses) yield /*35.40*/ {_display_(Seq[Any](format.raw/*35.42*/("""
                    <tr>
                        ...
                        """)))})),format.raw/*39.26*/("""
                        """),_display_(Seq[Any](/*40.26*/if(user == "professor")/*40.49*/{_display_(Seq[Any](format.raw/*40.50*/("""
